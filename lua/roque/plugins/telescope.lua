return {
  ...
  config = function()
    local horizontal_dropdown = require("telescope.themes").get_dropdown({
      layout_strategy = "horizontal",
      layout_config = { preview_width = 0.6, height = 0.8, width = 0.9 },
      border = true,
      borderchars = { " ", " ", " ", " ", "╭", "╮", "╯", "╰" },
    })
    ...
    require("telescope").setup({
      ...
      pickers = {
        ...
        live_grep = horizontal_dropdown,
        find_files = horizontal_dropdown,
        buffers = horizontal_dropdown,
      },
    })
